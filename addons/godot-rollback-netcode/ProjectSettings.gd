...
func add_project_settings() -> void:
	...
	_add_project_setting(
		"network/rollback/limits/max_input_frames_per_message", TYPE_INT, 5, PROPERTY_HINT_RANGE, "0, 60"
	)
	_add_project_setting("network/rollback/limits/max_messages_at_once", TYPE_INT, 2, PROPERTY_HINT_RANGE, "0, 10")
	_add_project_setting(
		"network/rollback/limits/max_ticks_to_regain_sync", TYPE_INT, 300, PROPERTY_HINT_RANGE, "0, 600"
	)
	...
	_add_project_setting(
		"network/rollback/classes/message_serializer", TYPE_STRING, "", PROPERTY_HINT_FILE, "*.gd,*.cs"
	)
	...
	_add_project_setting(
		"network/rollback/debug/physics_process_msecs", TYPE_FLOAT, 10.0, PROPERTY_HINT_RANGE, "0.0, 60.0"
	)
	...
	_add_project_setting(
		"network/rollback/log_inspector/replay_match_scene_path", TYPE_STRING, "", PROPERTY_HINT_FILE, "*.tscn,*.scn"
	)
	_add_project_setting(
		"network/rollback/log_inspector/replay_match_scene_method", TYPE_STRING, "setup_match_for_replay"
	)
